...
namespace locomotion_viewer {
    ...
    public:
        ...
        bool publishEigenSpheres(const Eigen::VectorXd & eigen_path_x,
        ...
        // NB: As soon as I turn this into const-ref for Eigen::Vector3d it has a symbol lookup error. Dont know why
